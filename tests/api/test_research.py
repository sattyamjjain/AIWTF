...
async def test_research_endpoint_success(async_client, mock_research_service, mock_research_response):
    """Test successful research endpoint"""
    mock_research_service.research_topic_from_request.return_value = MOCK_RESEARCH_RESPONSE
...
async def test_research_endpoint_error(async_client, mock_research_service):
    """Test error handling"""
    mock_research_service.research_topic_from_request.side_effect = Exception("Test error")
