...
class WebSearchTool(BaseTool):
    ...
    def __init__(self, provider_type: str = "auto", api_key: Optional[str] = None, cx: Optional[str] = None):
        super().__init__()
        # Use object.__setattr__ to bypass Pydantic validation
        object.__setattr__(self, "_provider", get_search_provider(provider_type, api_key, cx))
